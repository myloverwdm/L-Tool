...
export function AddOrUpdateDataBaseInfo(arg1:db.DataBaseInfo,arg2:boolean):Promise<string>;
...
export function GetAllDataBaseInfo():Promise<Array<db.DataBaseInfo>>;
