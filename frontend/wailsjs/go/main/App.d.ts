...
export function CreateDatabase(arg1:string,arg2:string,arg3:info.DataBaseCreateForm):Promise<global.LToolResponse>;

export function DeleteOneDataBaseInfo(arg1:string):Promise<string>;

export function DeleteZk(arg1:string):Promise<string>;

export function GetAllCharset(arg1:string,arg2:string):Promise<{[key: string]: Array<string>}>;
...
export function GetDataBaseDDL(arg1:string,arg2:string,arg3:string):Promise<string>;

export function GetDataBaseListByRegName(arg1:string):Promise<global.LToolResponse>;

export function GetDataBaseType(arg1:string):Promise<string>;
...
export function T1(arg1:string):Promise<info.DataBaseCreateForm>;
