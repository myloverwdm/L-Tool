      ...
      <el-tab-pane :label="value" :name="value">
        <div v-for="group in codeGroup">
          <div v-if="hideOneGroup(group)">
            ...
            <!--          一个代码的Tab-->
            <el-tabs type="card" class="demo-tabs" :model-value="languageType === 'ALL' ? group.codeList[0].type : languageType">
              <!--            遍历所有的类型-->
              <div v-for="code in group.codeList">
                <el-tab-pane :label="code.type" :name="code.type" v-if="languageType === 'ALL' || code.type === languageType">
                  <el-button
                      style="margin-top: 10px;margin-left: 80%;position: fixed;z-index: 9"
                      key="primary"
                      type="primary"
